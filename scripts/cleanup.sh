...
# Hat tip to José Riguera Lopez, original author of this script:
# https://github.com/jriguera/packer-ironic-images/blob/master/centos/scripts/cleanup.sh
